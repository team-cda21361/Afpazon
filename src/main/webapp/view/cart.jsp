...
<table class="table align-middle">
  ...
  <tbody>
    <tr>
      <td class="col-md-3"><img src="assets/images/products/product-1.jpg" width="65%" alt="#"></td>
      <td class="align-middle">Titre produit1</td>
      <td>30 &euro;</td>
      <td class="col-md-3"><i class="bi bi-dash-circle p-3"></i>2<i class="bi bi-plus-circle  p-3"></i></td>
      <td>Total</td>
    </tr>
    <tr>
      <td class="col-md-3"><img src="assets/images/products/product-1.jpg" width="65%" alt="#"></td>
...
<button class="btn btn-success" type="submit"> Passer la commande </button>
</div>
</div>
