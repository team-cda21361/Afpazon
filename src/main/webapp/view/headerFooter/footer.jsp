					...
					<div class="col-md-6 col-12">
						...
						<div class="single-footer f-contact">
							...
							<p>Afpazon est une entreprise de commerce en ligne fran�aise
								...
								vente de produits avec une philosophie tr�s simple � On vend
								tout �</p>
						</div>
						<!-- End Single Widget -->
					</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-4 col-12">
						<div class="payment-gateway">
							<span>We Accept:</span> <img src="assets/images/footer/credit-cards-footer.png" alt="#">
						</div>
					</div>
					<div class="col-lg-4 col-12">
						<div class="copyright">
							<p>
								Designed and Developed by SPEAR-Prod<a href="https://graygrids.com/" rel="nofollow"
