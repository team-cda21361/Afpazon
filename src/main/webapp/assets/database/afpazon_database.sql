...
INSERT INTO user (`id`, `lastName`, `firstName`, `email`, `password`, `gender`, `phone`, `registrationDate`, `isActive`, `id_role`) VALUES
    (1, 'Wayon', 'Anatol', 'awayon0@deliciousdays.com', 'W2OAbBftHOr', 'M.', '0917848282', '2022-07-28', 1, 1),
    (2, 'Foxwell', 'Jesse', 'jfoxwell1@rakuten.co.jp', 'FpCoGsmq3XR', 'M.', '0207367433', '2022-06-27', 1, 1),
    (3, 'Lunck', 'Joannes', 'jlunck2@telegraph.co.uk', '5BuzIa7P2', 'Mme.', '0995520217', '2023-03-15', 1, 1),
    (4, 'Blow', 'Charmine', 'cblow3@youtube.com', 'EfHh3hmDM', 'Mme.', '0142308695', '2022-04-09', 1, 1),
    (5, 'Cockell', 'Melantha', 'mcockell4@about.com', 'LOqqGm', 'Mme.', '0268099382', '2022-09-25', 1, 1),
    (6, 'Geffcock', 'Tybie', 'tgeffcock5@diigo.com', '35fDsBYfP', 'Mme.', '0944446893', '2022-09-03', 1, 1),
    (7, 'Mellor', 'Royall', 'rmellor6@weibo.com', 'zsctCsTrm', 'M.', '0376167727', '2023-01-11', 1, 1),
    (8, 'alffy', 'Babita', 'bpalffy7@mashable.com', 'A8cXbp4s7', 'Mme.', '0269671050', '2022-09-27', 1, 1),
    (9, 'Daber', 'Glyn', 'gdaber8@mozilla.com', '5lNP8w9vg', 'Mme.', '0298592896', '2022-04-19', 1, 1),
    (10, 'Erskine', 'Cristobal', 'cerskine9@intel.com', 'ZubeOfZN', 'M.', '0921068139', '2022-08-06', 1, 1),
    (11, 'Ryce', 'Gale', 'grycea@forbes.com', 'jslPfNrjfTDm', 'M.', '0249273666', '2023-02-17', 1, 1),
    (12, 'Penhaleurack', 'Georgiana', 'gpenhaleurackb@microsoft.com', '1zr7iX3', 'Mme.', '0601745513', '2022-10-12', 0, 1),
    (13, 'Shedden', 'Cesaro', 'csheddenc@miitbeian.gov.cn', 'nKPdug', 'M.', '0673669765', '2022-05-07', 1, 1),
    (14, 'Flemming', 'Boycey', 'bflemmingd@dot.gov', 'i8NOQ4XGIq42', 'M.', '0156893119', '2023-03-20', 0, 1),
    (15, 'Postlewhite', 'Tammy', 'tpostlewhitee@wordpress.org', '1ukzmKG3b', 'Mme.', '0555659671', '2022-05-27', 1, 1),
    (16, 'Clewer', 'Brion', 'bclewerf@phoca.cz', 'IpiFNLBJV4Vb', 'M.', '7985378277', '2023-01-19', 0, 1),
...
INSERT INTO `address` (`id`, `address`, `zipCode`, `city`, `id_user`, `id_address_type`) VALUES
    ...
    (5, '2 Hauk Street', 61205, 'Penhascoso', 2, 1),
    ...
    (10, '4 Warrior Plaza', 32187, 'Giebułtów', 2, 2),
